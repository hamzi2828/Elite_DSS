            ...
            <section class="featured-section">
                <div class="container">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-6">
                            <article class="featured-card h-100">
                                ...
                                <div class="featured-content">
                                    ...
                                    <a href="Blogs-detail.html" class="featured-title">
                        ...
                        <div class="col-12 col-lg-6">
                            <article class="featured-card h-100">
                                <img src="{{asset('images/blogs_card.png')}}" alt="Featured Article 2" class="featured-image" />
                                <div class="featured-content">
                                    <div class="featured-meta">
                                        <span class="featured-date">09-12-2024</span>
                                        <div class="featured-author">
                ...
                <div class="container">
                    <div class="row section-content">
                        ...
                        <div class="col-12 col-lg-8">
                            <!-- Planning Section -->
                            <a href="#" class="featured-heading">Planning</a>

                            <article class="article-card">
                                <div class="article-contents">
                                    <div>
                                        <a href="#" class="article-title">
                                            Writing a Strong Academic Statement: A Comprehensive
                                            Guide for Graduate Applications
                                        </a>
                                    ...
                                    <div class="article-meta">
                                        ...
                                        <div class="featured-author">
                                            <span class="circle-icon">
                                                <img src="{{asset('images/Ellipse 1.svg')}}" alt="" srcset="" /></span>
                                            <span class="featured-author-label name">Author: </span>
                                            <span class="name">Jessie Anderson</span>
                                        </div>
                                    </div>
                                </div>
                                <img src="{{asset('images/blogs_card.png')}}" alt="Article Image" class="article-image" />
                            </article>

                            <!-- Motivation Section -->
                            <a href="#" class="featured-heading mt-5">Motivation</a>
                            <article class="article-card">
                                <div class="article-contents">
                                    <div>
                                        <a href="#" class="article-title">
                                            Finding Your Inner Drive: The Science Behind
                                            Self-Motivation
                                        </a>
                                    ...
                                    <div class="article-meta">
                                        <span class="article-date">08-12-2024</span>
                                        <div class="featured-author">
                                            <span class="circle-icon">
                                                <img src="{{asset('images/Polygon 1.svg')}}" alt="" srcset="" /></span>
                                            <span class="featured-author-label name">Author: </span>
                                            <span class="name">Sarah Martinez</span>
                                        </div>
                                    </div>
                                </div>
                                <img src="{{asset('images/blogs_card.png')}}" alt="Motivation Article" class="article-image" />
                            </article>

                            <!-- Inspiration Section -->
                            <a href="#" class="featured-heading mt-5">Inspiration</a>
                            ...
                            <article class="article-card">
                                <div class="article-contents">
                                    ...
                                    <div class="article-meta">
                                        ...
                                        <div class="featured-author">
                                            <span class="circle-icon">
                                                <img src="{{asset('images/Star 1.svg')}}" alt="" srcset="" /></span>
                                            <span class="featured-author-label name">Author: </span>
                        ...
                        ">Author:
                                            ...
                                            <span style="color: #6d6d6d; font-size: 10px">Jessie Anderson</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- Popular Item 2 -->
                        ...
                        ">Author:
                                            ...
                                            <span style="color: #6d6d6d; font-size: 10px">Sarah Martinez</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- Popular Item 3 -->
                        ...
                        ">Author:
                                            ...
                                            <span style="color: #6d6d6d; font-size: 10px">Michael Chen</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
