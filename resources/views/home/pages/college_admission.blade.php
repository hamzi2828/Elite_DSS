        ...
        <div class="container">
          <div class="row section-content">
            ...
            <div class="col-12 col-lg-8">
              <!-- Planning Section -->
              <a href="#" class="featured-heading"> College Admission </a>
              ...
              <article class="article-card">
                ...
                <img
                  src="{{asset('images/blogs_card.png')}}"
                  alt="Inspiration Article"
                  class="article-image"
                />
              </article>
              <article class="article-card">
              ...
              <nav aria-label="Pagination" class="pagination-container">
                ...
                <a
                  href="#"
                  class="pagination-link pagination-link-default pagination-link-disabled"
                ...
                <a
                  ...
                  data-page="2"
                >
                  <span class="pagination-number pagination-number-default"
                    >2</span
                  >
                </a>
